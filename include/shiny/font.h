...
bool shiny_font_draw_text(const shiny_font_t *font, float x, float y,
	float text_size, const char *text, Sint32 length);

void shiny_font_measure_text(const shiny_font_t *font, const char *text,
	int text_length, float text_size, float *width, float *height);
